...
interface CookieEditorClientProps {
  initialPage: PageData | null;
}

export function CookieEditorClient({ initialPage }: CookieEditorClientProps) {
  ...
  const [titleTr, setTitleTr] = useState(initialPage?.titleTr || "Çerez Politikası");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setSuccess("Çerez politikası başarıyla kaydedildi.");
      router.refresh();
    } catch (err) {
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Çerez politikası sayfasının içeriğini düzenleyin
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="flex w-full rounded-lg border-2 border-gray-600 dark:border-gray-400 bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder:text-gray-500 dark:placeholder:text-gray-400"
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                placeholder={
                  activeTab === "tr"
                    ? "<h2>Çerez Politikası</h2>\n<p>Bu web sitesi çerezler kullanmaktadır...</p>"
              ...
              <div className="mt-3 rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-6">
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: currentContent || "<p class='text-gray-400'>Henüz içerik girilmedi.</p>",
                  }}
                />
              </div>
            )}
