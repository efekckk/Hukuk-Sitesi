...
const FIELD_CONFIG: FieldConfig[] = [
  ...
  {
    key: "phone",
    label: "Telefon (Görüntülenecek)",
    placeholder: "örn. +90 (212) 266 00 76",
    hasTr: true,
    hasEn: false,
  },
  {
    key: "phone_raw",
    label: "Telefon (Ham — tel: href için)",
    placeholder: "örn. +902122660076",
    hasTr: true,
    hasEn: false,
  },
  {
    key: "email",
    label: "E-posta",
    placeholder: "örn. info@aebhukuk.com",
    hasTr: true,
    hasEn: false,
  },
  {
