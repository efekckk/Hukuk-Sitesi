  ...
  const practiceAreas = [
    {
      ...
      image: "/images/yatırımdanısmanlığı.webp",
    ...
    },
    {
      ...
      image: "/images/concept-of-auction-composition-with-wooden-hammer-2026-01-09-07-14-29-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, müvekkillerini hukuki uyuşmazlıklarda gerek arabuluculuk ve mahkeme dışı sulh süreçlerinde, gerekse uyuşmazlıkların mahkemeler nezdinde çözümünde temsil etmektedir. Uyuşmazlığın konusu her ne olursa olsun, deneyimli dava avukatlarımız ve icra takibi ekibimiz, kişi ve kuruluşlara, yerli ve yabancı sermayeli şirketlere, banka ve finans kurumlarına hukuki destek sağlamaktadır. Uyuşmazlık Çözümü Birimimiz, iki ekipten oluşmaktadır. Dava Takibi Ekibimiz, yerli ve yabancı müvekkillerimize kompleks uyuşmazlıkların çözümünde danışmanlık hizmeti vermekte ve müvekkillerimizi mahkemeler nezdinde temsil etmektedir. İcra Takibi Ekibimiz ise bireysel ve ticari alacakların tahsili konusunda uzmanlaşmış olup, takip ve takip öncesi tahsilat süreçlerinde Türkiye'nin lider bankaları, finans kuruluşları ve telekomünikasyon şirketlerine hizmet vermektedir.\n\nSıklıkla karşılaştığımız ve çözümünde yer aldığımız başlıca hukuki uyuşmazlık konuları aşağıdakilerdir:\n\nAlternatif Uyuşmazlık Çözümleri, Ticari davalar ve Şirketler Hukukundan doğan davalar, Hissedarlar arasındaki uyuşmazlıklar, Gayrimenkul ve orman davaları, İnşaat Uyuşmazlıkları, İş davaları, Sigorta davaları ve tahkim süreçleri, Gümrük ve uluslararası ticaret, Taşıma ve lojistik davaları, Tüketicinin Korunması, Vergi davaları ve anlaşmazlık çözümleri, Fikri Mülkiyet, İdare ve Kamu Hukuku, Ceza Hukuku",
    ...
    },
    {
      ...
      image: "/images/businessmen-investors-shake-hands-with-lawyers-to-2026-01-08-02-27-24-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, gayrimenkul sektöründe faaliyet gösteren müvekkillerine sektörde ortaya çıkan sorunlara yönelik stratejik ve düşük maliyetli çözümler sunar. Bu kapsamda danışmanlık sağlanan müvekkiller arasında; arsa sahipleri, gayrimenkul geliştiricileri, yükleniciler, işleticiler, gayrimenkul alıcı ve satıcıları ile kiraya verenler, kiracılar yer almaktadır.\n\nGayrimenkul Ekibimiz, ayrıca orman arazilerine yönelik tazminat davaları, tapu iptallerinden doğan uyuşmazlıklar, Osmanlı tapularının aplikasyonu, kamulaştırma ve kamulaştırmasız el atma konulu davalarda da deneyim sahibidir.",
    ...
    },
    {
      ...
      image: "/images/businessmen-investors-shake-hands-with-lawyers-to-2026-01-08-02-27-24-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, finans; gayrimenkul, inşaat, perakende satış, turizm, yiyecek-içecek, teknoloji ve telekomünikasyon başta olmak üzere çeşitli sektörlerde faaliyet gösteren yerel ve uluslararası şirketlerin dâhil olduğu birleşme ve devralma süreç ve işlemlerinin her aşamasında sonuç odaklı danışmanlık hizmeti vermektedir.\n\nBirleşme ve Devralmalar Ekibimizin verdiği hizmetleri aşağıdaki gibi özetleyebiliriz:\n\n• Hukuki durum ve risk analizi,\n• Birleşme sözleşmeleri, ortak girişim sözleşmeleri, hisse devir sözleşmeleri, hisse rehin sözleşmeleri, oy anlaşmaları, hâkimiyet sözleşmeleri ve hissedarlık sözleşmelerinin hazırlanması ve müzakere edilmesi, kapanış işlemleri, sektör bazında değişkenlik gösteren izin ve ruhsatların alınması ve bunlara ilişkin gerekli takip formalitelerinin yerine getirilmesi,\n• Devralmalar sonrası entegrasyon ve hisse devirleri sonrası reorganizasyon süreçlerine yönelik danışmanlık,\n• Şirket uygulamalarının yerel mevzuata ve global şirket uygulamalarına uyumunun sağlanması, şirket içi kurumsal yönetim kurallarının ve şirket tüzüklerinin oluşturulması.",
    ...
    },
    {
      ...
      image: "/images/lawyer-discussing-with-client-about-contract-agre-2026-01-08-06-22-17-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, marka, telif hakları, endüstriyel tasarımlar, patent hakları, alan adı uyuşmazlıkları, ticari sırların korunması ve haksız rekabet de dâhil olmak üzere fikri mülkiyet hukukunun her alanında hizmet vermektedir.\n\nFikri Haklar konusunda uzmanlaşmış ekibimiz, sunmakta olduğu danışmanlık hizmetlerinin yanı sıra, sınai hakların Türk Patent ve Marka Kurumu nezdinde takibi ile fikri mülkiyet haklarının ihlaline ilişkin patent, marka, telif hakları, haksız rekabet, paralel ithalat ve ticari sırlara dair uyuşmazlıkları içeren tüm davalarda müvekkillerimizi başarıyla temsil etmektedir.",
    ...
    },
    {
      ...
      image: "/images/concept-of-auction-composition-with-wooden-hammer-2026-01-09-07-14-29-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, icra ve iflas takiplerine alacaklı veya borçlu sıfatıyla taraf olan müvekkillerinin çıkarlarını müdafaa eder. Bu kapsamda yerli, yabancı şahıs ve kurumların alacaklarının takip edilmesi, bu takip sonucunda borçlu mal varlığı üzerinde haciz işlemlerinin uygulanması, borçlu malvarlığının satış yoluyla paraya çevrilmesi ve müvekkillerin alacaklarına kavuşması sağlanır. İcra ve İflas Hukukundan doğan davalarda müvekkillerin mahkeme nezdinde temsil edilmesi de ekibimizin başlıca faaliyet alanlarındandır.\n\nYeniden Yapılandırma Ekibimiz, ayrıca, müvekkillere yeniden yapılandırma ve aciz hali gibi mali bakımdan sıkıntılı süreçlerin her aşamasında destek verir. Takım arkadaşlarımız, yeniden yapılandırma ve ilgili uyuşmazlık süreçlerinde tüm müvekkillere yaratıcı, pratik tavsiyeler ve çözüm yolları üretmenin yanı sıra finansal zorlukların üstesinden gelebilecek, pay sahiplerinin gelecekteki menfaatlerini ve aynı zamanda yöneticileri ve yetkilileri gereksiz sorumluluklardan koruyabilecek yapısal seçenekler sunar.",
    ...
    },
    {
      ...
      image: "/images/lawyer-discussing-with-client-about-contract-agre-2026-01-08-06-22-17-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, müvekkiller ile sigorta şirketleri arasındaki ilişkilere yönelik danışmanlık hizmeti vermekte ve rücu ilişkisinden doğan davalarda müvekkillerini temsil etmektedir. Avukatlarımız, davalarda, tahkim ve diğer alternatif çözüm yolları ile uzlaşma müzakerelerinde müvekkillerimize destek vermenin yanı sıra, sigortalama aşamasından önce poliçelere risk değerlendirmeleri yaparak, uyuşmazlıklar henüz ortaya çıkmadan önlenmelerini sağlar.\n\nSigorta Hukuku Birimimiz uyuşmazlıkların çözümüne yönelik özel müzakere, uzlaşma veya dava stratejileri geliştirmekte ve çoğu zaman uyuşmazlığın ilk aşamalarında uzlaşıyı sağlamaktadır. Ekip üyelerimizin, ticari sorumluluk; yöneticilerin ve yetkililerin sorumluluğu, mesleki sorumluluk, mal zararı, inşaat ayıpları, siber güvenlik ve veri ihlali, ürün sorumluluğu, hasar, hayat, kaza ve sağlık sigortası gibi birçok poliçe türüne ilişkin kapsamlı deneyimi vardır.",
    ...
    },
    {
      ...
      image: "/images/businessmen-investors-shake-hands-with-lawyers-to-2026-01-08-02-27-24-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, farklı sektörlerden yerel ve uluslararası birçok müvekkile, şirketler hukukuna ilişkin yasal gerekliliklerin yerine getirilmesi konusunda danışmanlık hizmeti vermektedir. Sunduğumuz hizmetler, şirketlerin, şubelerin ve irtibat bürolarının kurulumunun yanı sıra, yönetim kurulu toplantılarına yönelik danışmanlık hizmetleri, olağan ve olağanüstü genel kurul toplantılarının, sermaye artırımı ile azaltımı süreçlerinin yürütülmesi ile teknik iflas durumlarının değerlendirilmesi şeklinde geniş bir yelpazeye yayılmaktadır.\n\nŞirketler Hukuku ve Kurumsal Yönetim Birimimiz, grup şirketleri içi yeniden yapılandırma, bölünme, birleşme, tür değiştirme, tasfiye, malvarlığı ve pay devirleri, yönetim kurullarının yapılandırılması ve yönetim kurulu üyeleri arasında yetki sınırlandırmaları vb. konularda danışmanlık vermektedir. Ekibimiz, şirket organlarının kararları, iç yönerge ve imza sirkülerleri gibi önemli kurumsal belgelerin hazırlanması ve tadil edilmesi, ticaret siciline yapılan tescil başvuruları ile şirket kayıtlarının tutulması hususlarında müvekkillerine düzenli hizmet sunmaktadır.",
    ...
    },
    {
      ...
      image: "/images/lawyer-discussing-with-client-about-contract-agre-2026-01-08-06-22-17-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, Kişisel Verilerin Korunması Mevzuatı kapsamında farklı sektörlerden müvekkillerinin değişen ihtiyaçları doğrultusunda özelleştirilmiş uyum programları hazırlamaktadır.\n\nKişisel Verilerin Korunması Birimi, mevzuata uyum çerçevesinde, bu uyum programlarını hazırlarken, müvekkillerin iş süreçlerini analiz edip, uyumun sağlanması için öneriler geliştirmektedir.\n\nUyum programlarımız, 6698 sayılı Kişisel Verilerin Korunması Kanunu ile belirlenen sorumluluk rejimi bakımından şirket içi risklerin tespit edilerek, önlemler alınmasını; kurum bazında kişisel verilerin korunması politikaları geliştirilmesini, verilerin işlenmesinden sorumlu personelin eğitilmesi ve kanun tarafından öngörülen denetim yükümlülüğünün yerine getirilmesini amaçlamaktadır.\n\nKişisel verilerin korunması mevzuatı kapsamında sunduğumuz başlıca hizmetler:\n\n• Kişisel veri envanterinin hazırlanması ve veri akış şemalarının belirlenmesi,\n• Risklerin belirlenip analiz edilmesi,\n• Süreç bazlı uyum analizi yapılarak eksikliklerin belirlenmesi ve Kişisel Verilerin Korunması Mevzuatı kapsamında öneriler geliştirilmesi,\n• Mevzuata uyum çerçevesinde, açık rıza metinleri, aydınlatma beyanları, kişisel verilerin korunması ve gizlilik politikası, kişisel veri saklama ve imha politikası gibi gerekli hukuki belgelerin hazırlanması,\n• Uyumun devamlılığının kontrolü ve mevzuatla ilgili düzenli danışmanlık hizmetlerinin sunulması.",
    ...
    },
    {
      ...
      image: "/images/yatırımdanısmanlığı.webp",
      longDescTr: "Aşcı Etci Benglian, sınır ötesi emtia alım satımı, gümrük sorunları, deniz, hava ve kara yoluyla yük ve insan taşınması, lojistik, depolama ve antrepo hizmetleri başta olmak üzere lojistik ve taşımacılık hukuku üzerine her tür hukuki sorunun çözümü konusunda uzman ekibi sayesinde hızlı ve efektif hizmet sunmaktadır.\n\nSektörde faaliyet gösteren tüm şirketler, kendi ticaret düzenlerine uygun taşıma, depolama ve diğer tüm lojistik operasyonlarını en uygun ve etkin biçimde gerçekleştirmek arzusundadır. Bu sebeple taşımacılık ve lojistik, rekabet gücünde fark yaratan en önemli unsurlardan biri haline gelmiştir.\n\nSektör oyuncularının gelişmelere ayak uydurmaları ve ilgili mevzuata uyum gösterebilmeleri için avukatlarımız, taşımacılık ve lojistik sektöründe faaliyet gösteren müvekkillerimize şirketler ve ticaret hukuku, birleşme ve devralmalar, yapılandırmalar, yasalara uyumluluk ve sektöre özgü mevzuat gibi pek çok farklı konuda danışmanlık hizmeti vermektedir.",
    ...
    },
    {
      ...
      image: "/images/concept-of-auction-composition-with-wooden-hammer-2026-01-09-07-14-29-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, ayıplı mal ve ayıplı hizmet sunulmasından kaynaklanan uyuşmazlıklar başta olmak üzere, tüketici hukukuna ilişkin geniş bir yelpazede hukuki danışmanlık ve dava takibi hizmeti vermektedir.\n\nTüketici Hukuku Birimimiz, hakem heyetlerine yapılan başvurular de dâhil olmak üzere, tüketici şikâyetlerinin tüm aşamalarında ve tüketici mahkemeleri nezdinde müvekkilleri temsil etmektedir.\n\nAvukatlarımız, tüketici ve konut kredisi sözleşmeleri, abonelik sözleşmeleri, sözleşmelerdeki haksız şartlar başta olmak üzere yerel ve uluslararası müvekkillere tüketici haklarını ilgilendiren birçok konuda danışmanlık hizmeti sunmaktadır.",
    ...
    },
    {
      ...
      image: "/images/lawyer-discussing-with-client-about-contract-agre-2026-01-08-06-22-17-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian Avukatlık Ortaklığı, aile hukuku alanında boşanma davaları başta olmak üzere, evliliğin iptali, boşanmadan kaynaklanan tazminat, nafaka, velayet, mal rejiminin tasfiyesi, soy bağı uyuşmazlıklarından doğan davalar ile mal rejimi sözleşmelerini hazırlanması ve evlat edinmeler konusunda müvekkillerine danışmanlık hizmeti sunmaktadır.\n\nEkibimizin miras hukuku alanındaki çalışmaları ise genel olarak miras paylarının ve terekenin tespiti, ölüme bağlı tasarrufların iptali ve tenkisi ile muris muvazaası vb. miras hukukundan kaynaklanan davalar üzerinde yoğunlaşmıştır.",
    ...
    },
    {
      ...
      image: "/images/concept-of-auction-composition-with-wooden-hammer-2026-01-09-07-14-29-utc.jpg.webp",
      longDescTr: "Aşcı Etci Benglian, Türk Ceza Kanunu ve diğer özel kanunlardaki suç tiplerine ilişkin etkili dava takibi ve sunmanın yanı sıra; özellikle soruşturma işlemleri süresince karşılaşılabilecek gözaltı, tutuklama, arama ve el koyma, iletişimin kayda alınması, teknik araçlarla izlenme gibi tedbirlerin hukuki denetimi ve bu işlemler neticesinde verilen kararlara karşı yapılacak itirazlar konusunda deneyim sahibidir.\n\nCeza Hukuku Birimimiz özellikle görevi kötüye kullanma ve benzeri iddialar ile karşılaşan şirketlere, üst yöneticilere ve şahıslara, gerek önleyici adımlar, gerekse bunları hayata geçirme konusunda hukuki destek sağlar. Bu hassas ve önemli sonuçlar doğurabilecek konularla başa çıkmak kişiye ve duruma özel geliştirilmiş stratejiler uygulanmaktadır.\n\nAvukatlarımız, dolandırıcılık, güveni kötüye kullanma, belgede sahtecilik, kaçakçılık, zimmete para geçirme suçlarının soruşturma ve kovuşturma evrelerinde şüpheli, sanık veya mağdur konumunda olan kişileri başarıyla temsil etmektedir. Hazırlık soruşturması da dâhil olmak üzere, yargılamanın her aşamasında müvekkillere hukuki danışmanlık hizmeti sunulmaktadır.",
